...
import org.wso2.carbon.identity.user.self.registration.config.RegistrationStep;
import org.wso2.carbon.identity.user.self.registration.config.RegistrationStepExecutorConfig;
...
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.RegExecutorBindingType.AUTHENTICATOR;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepStatus.AGGREGATED_TASKS_PENDING;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepStatus.COMPLETE;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepStatus.NOT_STARTED;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepStatus.SELECTION_PENDING;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepStatus.USER_INPUT_REQUIRED;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepType.AGGREGATED_TASKS;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepType.MULTI_OPTION;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepType.SINGLE_OPTION;
