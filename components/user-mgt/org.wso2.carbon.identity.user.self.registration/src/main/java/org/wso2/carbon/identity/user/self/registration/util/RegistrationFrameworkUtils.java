...
import org.wso2.carbon.identity.user.self.registration.DefaultRegistrationSequenceHandler;
import org.wso2.carbon.identity.user.self.registration.RegistrationSequenceHandler;
...
import org.wso2.carbon.identity.user.self.registration.config.AuthSequenceBasedConfigLoader;
...
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.INITIAL_AUTH_REQUEST;
