...
import org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.RegExecutorBindingType;
import org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepStatus;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.RegExecutorBindingType.NONE;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepStatus.COMPLETE;
import static org.wso2.carbon.identity.user.self.registration.util.RegistrationConstants.StepStatus.NOT_HANDLED;
